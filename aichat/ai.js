(function () {
  ...
  async function simulatePrysmisAI(prompt) {
    var responses = [
      "I can help you with that! Here's a Lua script for your Roblox game:",
      "Great question! Let me create a solution for you.",
      "I'll write the perfect code for your Roblox project.",
      "Here's how you can implement this in Roblox Studio:",
    ...
    var randomCode = Math.random() > 0.5 ? codeExamples[Math.floor(Math.random() * codeExamples.length)] : null;
    
    return {
      response: randomResponse + (randomCode ? "\n\n" + randomCode : ""),
      code: randomCode
    };
  }
